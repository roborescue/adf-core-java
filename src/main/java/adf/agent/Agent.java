...
public abstract class Agent<E extends StandardEntity> extends AbstractAgent<StandardWorldModel, E> {
  ...
  public Agent(boolean isPrecompute, String dataStorageName, boolean isDebugMode, ModuleConfig moduleConfig,
  ...
  protected void postConnect() {
    ...
    switch (scenarioInfo.getMode()) {
      case NON_PRECOMPUTE:
        ConsoleOutput.out(ConsoleOutput.State.INFO, "Connected - " + this + " (NON_PRECOMPUTE)");
        break;
      case PRECOMPUTATION_PHASE:
        ConsoleOutput.out(ConsoleOutput.State.INFO, "Connected - " + this + " (PRECOMPUTATION)");
        break;
      case PRECOMPUTED:
        ConsoleOutput.out(ConsoleOutput.State.INFO, "Connected - " + this + " (PRECOMPUTED)");
        break;
      default:
    }
  }
