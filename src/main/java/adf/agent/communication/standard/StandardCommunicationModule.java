...
public class StandardCommunicationModule extends CommunicationModule {
  ...
  private void addReceivedMessage(@Nonnull MessageManager messageManager, boolean isRadio, @Nonnull EntityID senderID,
      byte[] data) {
    ...
    Object[] args = { Boolean.valueOf(isRadio), Integer.valueOf(senderID.getValue()), Integer.valueOf(messageTTL),
        bitStreamReader };
    try {
