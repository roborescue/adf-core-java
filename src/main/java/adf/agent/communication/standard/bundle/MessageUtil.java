...
public class MessageUtil {
  ...
  @Nullable
  public static StandardEntity reflectMessage( @Nonnull WorldInfo worldInfo,
      @Nonnull StandardMessage message ) {
  ...
  @Nonnull
  public static Building reflectMessage( @Nonnull WorldInfo worldInfo,
      @Nonnull MessageBuilding message ) {
    Building building = (Building) worldInfo
        .getEntity( message.getBuildingID() );
    if ( building != null ) {
  ...
  @Nullable
  public static Road reflectMessage( @Nonnull WorldInfo worldInfo,
      @Nonnull MessageRoad message ) {
    ...
    Blockade blockade = (Blockade) worldInfo
        .getEntity( message.getBlockadeID() );
    if ( blockade != null ) {
  ...
  @Nonnull
  public static Civilian reflectMessage( @Nonnull WorldInfo worldInfo,
      @Nonnull MessageCivilian message ) {
  ...
  @Nonnull
  public static AmbulanceTeam reflectMessage( @Nonnull WorldInfo worldInfo,
      @Nonnull MessageAmbulanceTeam message ) {
    AmbulanceTeam ambulanceteam = (AmbulanceTeam) worldInfo
        .getEntity( message.getAgentID() );
  ...
  @Nonnull
  public static FireBrigade reflectMessage( @Nonnull WorldInfo worldInfo,
      @Nonnull MessageFireBrigade message ) {
    FireBrigade firebrigade = (FireBrigade) worldInfo
        .getEntity( message.getAgentID() );
    if ( firebrigade != null ) {
      if ( message.isHPDefined() ) {
  ...
  @Nonnull
  public static PoliceForce reflectMessage( @Nonnull WorldInfo worldInfo,
      @Nonnull MessagePoliceForce message ) {
    PoliceForce policeforce = (PoliceForce) worldInfo
        .getEntity( message.getAgentID() );
    if ( policeforce != null ) {
      if ( message.isHPDefined() ) {
