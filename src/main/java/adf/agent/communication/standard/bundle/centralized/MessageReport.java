...
public class MessageReport extends StandardMessage {
  ...
  public MessageReport(boolean isRadio, StandardMessagePriority sendingPriority, boolean isDone, boolean isBroadcast,
      @Nullable EntityID fromID) {
  ...
  public String getCheckKey() {
    return getClass().getCanonicalName() + " isBroadcast:" + this.isBroadcast() + " fromID:" + this.getFromID();
  }
}
