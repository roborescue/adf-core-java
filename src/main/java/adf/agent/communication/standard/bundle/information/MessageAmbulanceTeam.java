...
public class MessageAmbulanceTeam extends StandardMessage {
  ...
  public MessageAmbulanceTeam(boolean isRadio, @Nonnull AmbulanceTeam ambulanceTeam, int action,
      @Nullable EntityID target) {
    this(isRadio, StandardMessagePriority.NORMAL, ambulanceTeam, action, target);
  }

  public MessageAmbulanceTeam(boolean isRadio, StandardMessagePriority sendingPriority,
