...
public class MessageRoad extends StandardMessage {
  ...
  public MessageRoad(boolean isRadio, @Nonnull Road road, @Nullable Blockade blockade, @Nullable Boolean isPassable,
      boolean isSendBlockadeLocation) {
    this(isRadio, StandardMessagePriority.NORMAL, road, blockade, isPassable, isSendBlockadeLocation);
  }

  public MessageRoad(boolean isRadio, StandardMessagePriority sendingPriority, @Nonnull Road road,
