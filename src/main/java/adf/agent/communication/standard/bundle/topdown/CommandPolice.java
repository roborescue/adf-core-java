 ...
 *             {@link adf.agent.communication.standard.bundle.centralized.CommandPolice}
 */
@Deprecated
public class CommandPolice
    extends adf.agent.communication.standard.bundle.centralized.CommandPolice {
