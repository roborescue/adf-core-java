 ...
 *             {@link adf.agent.communication.standard.bundle.centralized.CommandScout}
 */
@Deprecated
public class CommandScout
    extends adf.agent.communication.standard.bundle.centralized.CommandScout {
