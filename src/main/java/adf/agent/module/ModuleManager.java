...
public class ModuleManager {
  ...
  @Nonnull
  public final <T extends AbstractModule> T getModule(
      @Nonnull String moduleName, @Nullable String defaultClassName ) {
  ...
  private AbstractModule
      getModule( @Nonnull Class<AbstractModule> moduleClass ) {
    try {
  ...
  public final <E extends CommandExecutor<? extends CommunicationMessage>> E
    ...
    try {
      ...
      CommandExecutor<CommunicationMessage> instance = this.executorMap
          .get( className );
      if ( instance != null ) {
        return (E) instance;
      }
