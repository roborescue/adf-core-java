...
public class ModuleManager {
  ...
  public ModuleManager(@Nonnull AgentInfo agentInfo, @Nonnull WorldInfo worldInfo, @Nonnull ScenarioInfo scenarioInfo,
      @Nonnull ModuleConfig moduleConfig, @Nonnull DevelopData developData) {
  ...
  private AbstractModule getModule(@Nonnull Class<AbstractModule> moduleClass) {
    try {
      Constructor<AbstractModule> constructor = moduleClass.getConstructor(AgentInfo.class, WorldInfo.class,
          ScenarioInfo.class, ModuleManager.class, DevelopData.class);
  ...
  private ExtAction getExtAction(Class<ExtAction> actionClass) {
    try {
      Constructor<ExtAction> constructor = actionClass.getConstructor(AgentInfo.class, WorldInfo.class,
          ScenarioInfo.class, ModuleManager.class, DevelopData.class);
  ...
  private <E extends CommandExecutor<? extends CommunicationMessage>> E getCommandExecutor(Class<E> actionClass) {
    try {
      Constructor<E> constructor = actionClass.getConstructor(AgentInfo.class, WorldInfo.class, ScenarioInfo.class,
  ...
  private CommandPicker getCommandPicker(Class<CommandPicker> actionClass) {
    try {
      Constructor<CommandPicker> constructor = actionClass.getConstructor(AgentInfo.class, WorldInfo.class,
          ScenarioInfo.class, ModuleManager.class, DevelopData.class);
      CommandPicker instance = constructor.newInstance(this.agentInfo, this.worldInfo, this.scenarioInfo, this,
          this.developData);
