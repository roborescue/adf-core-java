...
public class OfficeAmbulance extends Office<Building> {
  ...
  public OfficeAmbulance(TacticsAmbulanceCentre tacticsAmbulanceCenter, boolean isPrecompute, boolean isDebugMode,
      ModuleConfig moduleConfig, DevelopData developData) {
    super(tacticsAmbulanceCenter, isPrecompute, DATASTORAGE_FILE_NAME_AMBULANCE, isDebugMode, moduleConfig,
        developData);
  }
