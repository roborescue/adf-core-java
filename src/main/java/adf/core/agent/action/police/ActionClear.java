...
public class ActionClear extends Action {
  ...
  public ActionClear(@Nonnull AgentInfo agent, @Nonnull Vector2D vector) {
    this((int) (agent.getX() + vector.getX()),
        (int) (agent.getY() + vector.getY()));
  }
  ...
  public String toString() {
    return "ActionClear [target=" + target + ", useOldFunction="
        + useOldFunction + ", posX=" + posX + ", posY=" + posY + "]";
  }
