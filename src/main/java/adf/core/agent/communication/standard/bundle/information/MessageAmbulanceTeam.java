...
public class MessageAmbulanceTeam extends StandardMessage {
  ...
  public MessageAmbulanceTeam(boolean isRadio, @Nonnull AmbulanceTeam ambulanceTeam, int action, @Nullable EntityID target) {
    this(isRadio, StandardMessagePriority.NORMAL, ambulanceTeam, action,
        target);
  }
  ...
  public MessageAmbulanceTeam(boolean isRadio, StandardMessagePriority sendingPriority, @Nonnull AmbulanceTeam ambulanceTeam, int action, @Nullable EntityID target) {
    ...
    this.humanBuriedness = ambulanceTeam.isBuriednessDefined()
        ? ambulanceTeam.getBuriedness()
        : -1;
    this.humanDamage = ambulanceTeam.isDamageDefined()
        ? ambulanceTeam.getDamage()
        : -1;
    this.humanPosition = ambulanceTeam.isPositionDefined()
  ...
  // public MessageAmbulanceTeam(int time, int ttl, int hp, int buriedness, int
  // damage, int position, int id, int target, int action)
  {
