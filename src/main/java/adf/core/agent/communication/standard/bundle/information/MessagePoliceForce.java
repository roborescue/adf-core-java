...
public class MessagePoliceForce extends StandardMessage {
  ...
  public MessagePoliceForce(boolean isRadio, StandardMessagePriority sendingPriority, @Nonnull PoliceForce policeForce, int action, @Nullable EntityID target) {
    ...
    this.humanBuriedness = policeForce.isBuriednessDefined()
        ? policeForce.getBuriedness()
        : -1;
    this.humanDamage = policeForce.isDamageDefined() ? policeForce.getDamage()
        : -1;
    this.humanPosition = policeForce.isPositionDefined()
