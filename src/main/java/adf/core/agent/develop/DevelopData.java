...
public final class DevelopData {
  ...
  public static final String DEFAULT_FILE_NAME = "config" + File.separator
      + "develop.json";
  ...
  public DevelopData(boolean developFlag, @Nonnull String developDataFileName, @Nonnull List<
      String> rawData) {
