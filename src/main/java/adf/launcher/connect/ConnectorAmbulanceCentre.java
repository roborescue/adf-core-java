  ...
  public void connect(ComponentLauncher launcher, Config config, AbstractLoader loader) {
    ...
    try {
      for (int i = 0; i != count; ++i) {
        ...
        launcher.connect(
            new OfficeAmbulance(tacticsAmbulanceCenter, config.getBooleanValue(ConfigKey.KEY_PRECOMPUTE, false),
      ...
      // ConsoleOutput.finish("[ERROR ] Cannot Load AmbulanceCentre Tactics !!");
    }
